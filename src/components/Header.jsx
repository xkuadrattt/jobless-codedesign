...
const Header = function () {
  ...
  const navMobile =
    "flex flex-col gap-4 absolute top-[3.6rem] w-full h-[90vh] overflow-hidden z-30 left-0 right-0 bg-white/80 backdrop-blur md:static md:w-auto md:flex-row md:h-auto md:gap-0";
